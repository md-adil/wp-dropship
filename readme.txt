...
- Sign up here to get a free trial account.
- Proceed with a Complete Registration by selecting a profile like “seller”.

2. How to connect your store with BiglyDropship
...
- There you can download the plugin and then create API Key for your store
- Add your Client Name e.g. Shop
- Here you get “API Key List”
- Go to WordPress Site and Login to Site
- Add the downloaded BiglyDropship Plugin here
...
3. Need to be registered on BiglyDropship to use this plugin features?
- Yes, you need to be register on BiglyDropship to create API keys.

4. How I can contact you?
